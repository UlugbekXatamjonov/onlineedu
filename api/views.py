...
from .serializers import CategoryAPISerializer, SubCategoryAPISerializer, ExampAPISerializer, \
    ...
    LessonAPISerializer, FreeSubCategoryAPISerializer, FreeCategoryAPISerializer, UnitAPISerializer
...
class UnitViewset(ModelViewSet):
    ...
    serializer_class = UnitAPISerializer
    permission_classes = [IsAuthenticatedOrReadOnly]
    lookup_field = 'slug'
...
class MyCourseViewSet(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        # try:
        #     lessons = Lessons.objects.filter(unit.course= course.id) # lessons - O'quvchining tanlagan kursidagi darslar ro'yhati
